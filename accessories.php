	          ...
	          <nav class="nav">	        	
	    	    <a href="#" id="w3-menu-trigger"> </a>
	                  <ul class="nav-list" style="">
							...
							<li class="nav-item"><a href="accessories.php">Phụ Kiện</a></li>
		...
		<div class="grids_of_3">
			...
			<div class="grid1_of_3">
				<a href="details7.php">
					...
					<div class="price">
						<h4>200.000 đ<span>indulge</span></h4>
					</div>
					<span class="b_btm"></span>
				</a>
			</div>
			<div class="grid1_of_3">
				<a href="details8.php">
					...
					<h3>branded tees</h3>
					<div class="price">
						<h4>300.000 đ<span>indulge</span></h4>
					</div>
					<span class="b_btm"></span>
				</a>
			</div>
		...
		<div class="grids_of_3">
			<div class="grid1_of_3">
				<a href="details9.php">
					...
					<h3>branded bags</h3>
					<div class="price">
						<h4>400.000 đ<span>indulge</span></h4>
					</div>
					<span class="b_btm"></span>
				</a>
			</div>
			...
			<div class="grid1_of_3">
				<a href="details11.php">
					...
					<div class="price">
						<h4>150.000 đ<span>indulge</span></h4>
					</div>
					<span class="b_btm"></span>
				</a>
			</div>
