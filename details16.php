	...
	<div class="single">
			...
			<div class="span1_of_1_des">
				  <div class="desc1">
					...
					<h5>3.000.000 đ <a href="#">click for offer</a></h5>
					<div class="available">
						...
						foreach ($product16 as $listproduct16) {
						 echo "<div class='btn_form'><a href='insert16.php?id=".$listproduct16['id']."'><h4><span>ORDER</span></h4>";
						}
						 ?>
							</form>
						</div>
