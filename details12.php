	...
	<div class="single">
			...
			<div class="span1_of_1_des">
				  <div class="desc1">
					...
					<h5>1.000.000 đ <a href="#">click for offer</a></h5>
					<div class="available">
						...
						foreach ($product12 as $listproduct12) {
						 echo "<div class='btn_form'><a href='insert12.php?id=".$listproduct12['id']."'><h4><span>ORDER</span></h4>";
						}
						 ?>
							</form>
						</div>
