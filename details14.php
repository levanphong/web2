...
<div class="wrap">
	<div class="header">
		...
		<ul class="icon1 sub-icon1">
			<li><a class="active-icon c1" href="#"><i>3.000.000</i></a>
	...
	<div class="single">
				...
				<div class="product-view">
				    ...
				    <div class="product-image"> 
				        <a class="cs-fancybox-thumbs cloud-zoom" rel="adjustX:30,adjustY:0,position:'right',tint:'#202020',tintOpacity:0.5,smoothMove:2,showTitle:true,titleOpacity:0.5" data-fancybox-group="thumb" href="images/0001-2.jpg" title="Women Shorts" alt="Women Shorts">
				           	<img src="images/tuisach1.jpg" alt="Women Shorts" title="Women Shorts" />
				        </a>
				   </div>
			...
			<div class="span1_of_1_des">
				  <div class="desc1">
					...
					<h5>2.000.000 đ <a href="#">click for offer</a></h5>
					<div class="available">
						...
						foreach ($product14 as $listproduct14) {
						 echo "<div class='btn_form'><a href='insert14.php?id=".$listproduct14['id']."'><h4><span>ORDER</span></h4>";
						}
						 ?>
							</form>
						</div>
