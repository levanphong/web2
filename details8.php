	...
	<div class="single">
			...
			<div class="span1_of_1_des">
				  <div class="desc1">
					...
					<h5>300.000 đ <a href="#">click for offer</a></h5>
					<div class="available">
						...
						foreach ($product8 as $listproduct8) {
						 echo "<div class='btn_form'><a href='insert8.php?id=".$listproduct8['id']."'><h4><span>ORDER</span></h4>";
						}
						 ?>
							</form>
						</div>
