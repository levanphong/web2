	...
	<div class="single">
			...
			<div class="span1_of_1_des">
				  <div class="desc1">
					...
					<h5>4.000.000 đ <a href="#">click for offer</a></h5>
					<div class="available">
						...
						foreach ($product6 as $listproduct6) {
						 echo "<div class='btn_form'><a href='insert6.php?id=".$listproduct6['id']."'><h4><span>ORDER</span></h4>";
						}
						 ?>
							</form>
						</div>
