	          ...
	          <nav class="nav">	        	
	    	    <a href="#" id="w3-menu-trigger"> </a>
	                  <ul class="nav-list" style="">
							...
							<li class="nav-item"><a href="shoes.php">Shoes</a></li>
...
<div class="wrap">	
	<div class="main">
		...
		<div class="grids_of_3">
			<div class="grid1_of_3">
				<a href="details12.php">
					...
					<h3>branded shoes</h3>
					<div class="price">
						<h4>1.000.000 đ<span>indulge</span></h4>
					</div>
					<span class="b_btm"></span>
				</a>
			</div>
			<div class="grid1_of_3">
				<a href="details13.php">
			...
			<div class="grid1_of_3">
				<a href="details14.php">
					<img src="images/shoe_pic3.jpg" alt=""/>
					<h3>branded shoes</h3>
					<div class="price">
						<h4>2.000.000<span>indulge</span></h4>
					</div>
					<span class="b_btm"></span>
				</a>
			</div>
		...
		<div class="grids_of_3">
			<div class="grid1_of_3">
				<a href="details15.php">
					<img src="images/shoe_pic4.jpg" alt=""/>
					<h3>branded shoes</h3>
					<div class="price">
						<h4>2.500.000<span>indulge</span></h4>
					</div>
					<span class="b_btm"></span>
				</a>
			</div>
			<div class="grid1_of_3">
				<a href="details16.php">
			...
			<div class="grid1_of_3">
				<a href="details17.php">
					<img src="images/shoe_pic6.jpg" alt=""/>
					<h3>branded shoes</h3>
					<div class="price">
						<h4>3.500.000<span>indulge</span></h4>
					</div>
					<span class="b_btm"></span>
				</a>
			</div>
