	...
	<div class="single">
			...
			<div class="span1_of_1_des">
				  <div class="desc1">
					...
					<h5>3.500.000 đ <a href="#">click for offer</a></h5>
					<div class="available">
						...
						foreach ($product17 as $listproduct17) {
						 echo "<div class='btn_form'><a href='insert17.php?id=".$listproduct17['id']."'><h4><span>ORDER</span></h4>";
						}
						 ?>
							</form>
						</div>
